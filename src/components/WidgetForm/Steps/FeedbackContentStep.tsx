...
interface FeedbackContentStepProps {
    ...
    onFeedbackRetartRequest: () => void
}

export function FeedbackContentStep({
    feedbackType,
    onFeedbackRetartRequest
        ...
        <>
            <header>
                <button
                    ...
                    onClick={onFeedbackRetartRequest}
                >
            ...
            <form className="my-4 w-full">
                ...
                <footer>
                    <button
                        type="submit"
                        className="bg-brand-500 rounded-md border-transparent p-2 flex-1 flex justify-center items-center text-sm "
                    ></button>
                </footer>
            </form>
        </>
